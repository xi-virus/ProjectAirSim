...
class ProjectAirSimDroneLandingEnv(ProjectAirSimEnv):
    def __init__(self):
    ...
    def reset(self):
        ...
        self.goal_pose = self.get_vec_from_pose(
            self.world.get_object_pose("TemplateCube_Rounded_150")
        )
    ...
    def get_observation(self):
        ...
        # print(f"pad xyz:{landing_pad_x} {landing_pad_y} {landing_pad_z}")
        # print(f"actor xyz:{actor_x} {actor_y} {actor_z}")
...
async def main():
    ...
    env = ProjectAirSimDroneLandingEnv()
    num_episodes = 2
