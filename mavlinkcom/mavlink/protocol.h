 ...
 */
static inline uint16_t mavlink_msg_get_send_buffer_length(
    const mavlink_message_t* msg) {
...
#elif !MAVLINK_ALIGNED_FIELDS
#define _mav_put_uint16_t(buf, wire_offset, b) \
  byte_copy_2(&buf[wire_offset], (const char*)&b)
#define _mav_put_int16_t(buf, wire_offset, b) \
  byte_copy_2(&buf[wire_offset], (const char*)&b)
#define _mav_put_uint32_t(buf, wire_offset, b) \
  byte_copy_4(&buf[wire_offset], (const char*)&b)
#define _mav_put_int32_t(buf, wire_offset, b) \
  byte_copy_4(&buf[wire_offset], (const char*)&b)
#define _mav_put_uint64_t(buf, wire_offset, b) \
  byte_copy_8(&buf[wire_offset], (const char*)&b)
#define _mav_put_int64_t(buf, wire_offset, b) \
  byte_copy_8(&buf[wire_offset], (const char*)&b)
#define _mav_put_float(buf, wire_offset, b) \
  byte_copy_4(&buf[wire_offset], (const char*)&b)
 ...
 */
static inline void _mav_put_char_array(char* buf, uint8_t wire_offset,
 ...
 */
static inline void _mav_put_uint8_t_array(char* buf, uint8_t wire_offset,
                                          const uint8_t* b,
 ...
 */
static inline void _mav_put_int8_t_array(char* buf, uint8_t wire_offset,
                                         const int8_t* b,
                                         uint8_t array_length) {
  mav_array_memcpy(&buf[wire_offset], b, array_length);
}
...
#define _MAV_PUT_ARRAY(TYPE, V)                                              \
  static inline void _mav_put_##TYPE##_array(                                \
      char* buf, uint8_t wire_offset, const TYPE* b, uint8_t array_length) { \
    if (b == NULL) {                                                         \
...
#define _MAV_MSG_RETURN_TYPE(TYPE, SIZE)                              \
  static inline TYPE _MAV_RETURN_##TYPE(const mavlink_message_t* msg, \
                                        uint8_t ofs) {                \
    TYPE r;                                                           \
...
static inline uint16_t _MAV_RETURN_char_array(const mavlink_message_t* msg,
                                              char* value, uint8_t array_length,
                                              uint8_t wire_offset) {
  memcpy(value, &_MAV_PAYLOAD(msg)[wire_offset], array_length);
  return array_length;
}

static inline uint16_t _MAV_RETURN_uint8_t_array(const mavlink_message_t* msg,
                                                 uint8_t* value,
                                                 uint8_t array_length,
                                                 uint8_t wire_offset) {
  memcpy(value, &_MAV_PAYLOAD(msg)[wire_offset], array_length);
...
static inline uint16_t _MAV_RETURN_int8_t_array(const mavlink_message_t* msg,
                                                int8_t* value,
                                                uint8_t array_length,
                                                uint8_t wire_offset) {
  memcpy(value, &_MAV_PAYLOAD(msg)[wire_offset], array_length);
...
#define _MAV_RETURN_ARRAY(TYPE, V)                                       \
  static inline uint16_t _MAV_RETURN_##TYPE##_array(                     \
      const mavlink_message_t* msg, TYPE* value, uint8_t array_length,   \
      uint8_t wire_offset) {                                             \
    uint16_t i;                                                          \
    for (i = 0; i < array_length; i++) {                                 \
      value[i] =                                                         \
          _MAV_RETURN_##TYPE(msg, wire_offset + (i * sizeof(value[0]))); \
    }                                                                    \
...
#define _MAV_RETURN_ARRAY(TYPE, V)                                     \
  static inline uint16_t _MAV_RETURN_##TYPE##_array(                   \
      const mavlink_message_t* msg, TYPE* value, uint8_t array_length, \
      uint8_t wire_offset) {                                           \
    memcpy(value, &_MAV_PAYLOAD(msg)[wire_offset],                     \
